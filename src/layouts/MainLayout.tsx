    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: sidebarBg, borderRight: `1px solid ${sidebarBorder}` }}>
      ...
      <Box sx={{ p: 3, pb: 2 }}>
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Box>
            <Typography variant="subtitle1" fontWeight={700} lineHeight={1.2}>CarbonCredit</Typography>
          ...
          <Toolbar sx={{ gap: 1, minHeight: { xs: 56, md: 60 } }}>
            ...
            >
              {crumbs.map((crumb, idx) => {
                ...
                return isLast ? (
                  <Typography key={crumb} variant="body2" fontWeight={600} color="text.primary">
                    {crumb}
                  </Typography>
                ) : (
                  <Link key={crumb} component={RouterLink} to="/dashboard" underline="hover"
            ...
            {/* Mobile title */}
            <Typography variant="subtitle1" fontWeight={600} sx={{ display: { sm: 'none' }, flex: 1 }}>
