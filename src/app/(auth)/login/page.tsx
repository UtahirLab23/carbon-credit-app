        ...
        <Card sx={{
          ...
          <CardContent sx={{ p: 5 }}>
            ...
            <Stack sx={{ alignItems: 'center', mb: 4 }} spacing={1.5}>
              ...
              <Typography variant="h5" sx={{ fontWeight: 700 }} color="text.primary">Carbon Credit Exchange</Typography>
            ...
            <Alert severity="info" sx={{
              ...
              Use any seeded account credentials to sign in.
            </Alert>
            ...
            <form onSubmit={handleSubmit}>
              <Stack spacing={2.5}>
                ...
                <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
                  <FormControlLabel
                    control={<Checkbox checked={remember} onChange={(e) => setRemember(e.target.checked)} size="small" color="primary" />}
                ...
                <Button type="submit" variant="contained" fullWidth size="large" disabled={loading} sx={{
                  ...
                  '&:hover': { boxShadow: '0 6px 20px rgba(76,175,80,0.45)' },
                }}>
